<?php
if (get_theme_mod('simpleshop_homepage_display_popular_products', true)) :
?>
         ...
         <div class="row justify-content-md-center">
            <div class="col-md-8">
               <div class="section-title text-center">
                  <h2 class="title ">
                     <?php
                        echo get_theme_mod('simpleshop_homepage_popular_products_title', __('Popular Product', 'simpleshop'));
                     ?>
                  </h2>
