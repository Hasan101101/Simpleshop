...
add_filter('wp_calculate_image_sizes', '__return_empty_array'); // To stop wp auto generated responsive image size
add_filter('wp_calculate_image_srcset', '__return_empty_array'); // To stop wp auto generated image srcset

// ::::::: Removing Hooks Start ::::::::
...
add_action('woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_add_to_cart', 10); // To add add to cart button
...
// To wrap img and cart icon by desire tag/class in markup (starting hook)
...
// To wrap img and cart icon by desire tag/class in markup (Ending hook)
...
// To remove shop page products result count
// remove_action('woocommerce_before_shop_loop', 'woocommerce_result_count', 20);

// To remove shop page products catalog
// remove_action('woocommerce_before_shop_loop', 'woocommerce_catalog_ordering', 30);

// To wrap shop page's products result count and products catalog by desire tag/class in markup (Staring hook)
...
// To wrap shop page's products result count and products catalog by desire tag/class in markup (Ending hook)
add_action('woocommerce_before_shop_loop', function () {
	?>
	</div>
<?php
